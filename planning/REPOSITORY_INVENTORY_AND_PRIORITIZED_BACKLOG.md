...
|---|---|---|---|---|
| **ADR-003's rehearsal role card + live instructor-as-client brief** (two artifacts, not one) | Task 1.4 (`fec3526`) → re-delegated to 1.3 (master plan `:99`, `:109`) → 1.3 shipped as B-005 (`601a214`) without it | `grep -rn "rehears\|instructor-as-client\|role card" drafts/cts285/assignments/Week_0[34]*` → 0. `Week_03:103` promises students a live Week 4 interview; `Week_04:32,:36` delivers a transcript re-read while objective 1 (`:24`) still says "**Conduct** structured stakeholder interviews." | **Unassigned.** Not B-008 — that item is activity handouts and checklists, a different scope, gated behind B-004…B-007. | 2026-07-24 |
