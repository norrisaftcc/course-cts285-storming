...
| **Attempt** | A single try at one Problem within a Session. At most **two** per problem. | try_number (1–2), entered_answer, is_correct | Manual pp.4–5, 22 (two tries; EEE on wrong; correct answer shown after 2nd miss); Teacher ("first-try vs second-try tells me knows-it vs guessed-it") |
