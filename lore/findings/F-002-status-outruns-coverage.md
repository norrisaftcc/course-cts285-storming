...
| Delegation | ADR-003's rehearsal role card + live instructor-as-client brief: **9 reference sites**, delegated to task 1.4, re-delegated to 1.3 (master plan `:99`, `:109`), shipped by **neither** | 2026-08-06 | **open** |
| Delegation | The ADR rail: PRISM `:12,:23` define CTS-285's exit tier as banking ADRs; `Week_05:291` still reads "Design Rationale (400–600 words)"; `grep ADR-lite drafts/` returns 0 | 2026-08-06 | **open** |
