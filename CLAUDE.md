...
- **Phase 1 (CTS-285 wks 1–12 Dataman conversion): IN PROGRESS.** Built so far: `drafts/cts285/assignments/` Weeks 01–07, 09, 11, 12 (Week 01 rewritten around the Dataman spine, B-004); `knowledge-checks/` Module 01 Dataman document-analysis quiz (15 pts, 12 autograded items) + Modules 02–06; six planning-sheet templates + `WIRING_MANIFEST.md`; the 1.0a shared Dataman artifact set (3 stakeholder transcripts, reference ERD, seeded backlog, grading key); points-normalization conflict ledger; `drafts/spikes/datamon-virtual-pet-reskin.md`.
