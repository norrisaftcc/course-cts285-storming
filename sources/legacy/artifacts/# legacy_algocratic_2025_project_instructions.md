<!--
  ...
  origin: /Users/norrisa/Documents/dev/github/course-cts285-template/artifacts/# legacy_algocratic_2025_project_instructions.md
  verdict: HARVEST
  target-26FA-slot: n/a
  ingest-date: 2026-07-23
  HARVEST: 179 lines. Leading '#' + spaces in filename breaks shell/link tooling. Contains the 'dynamic tension between Here to Help and satirizing workplace' design rationale and the velocity/trajectory dashboard concept — genuinely useful voice-cano
  NOTE: body preserved verbatim below; defects (terminology/points/framing) are intentional evidence.
-->
# legacy_algocratic_2025_project_instructions.md

<thanks it has to actually teach them to grow>Resolve this Dynamic Tension between "Here to Help" and "Satirizing actual workplace challenges"
---
✨ ELEGANT SOLUTION: STARTUP-THEMED GROWTH GAMIFICATION
The Core Product:
What it looks like: A professional performance dashboard tracking "velocity" and "trajectory"
What it measures: Learning acceleration (dy/dx, not y)
What it teaches: Growth mindset through positive reinforcement
What it celebrates: Iteration, improvement, and helping others
The Beautiful Simplicity:
yamlEvery Commit → Instant Feedback → Visible Progress → Behavior Change

No punishment, only "opportunities for optimization"
No surveillance, only "performance insights"
No dystopia, only "The Algorithm's helpful suggestions"

The Three-Layer Architecture:

Surface: Fun startup metrics ("crushing it!", "shipping velocity")
Middle: Real pedagogical measurement (iteration count, complexity growth)
Deep: Growth mindset reinforcement (celebrating attempts over results)

Why This Works:

Startup language makes it feel professional, not punitive
"Suboptimal" and "misaligned" are gentler than "failure"
AI agents get scored too, normalizing AI as a tool
Public metrics create positive peer pressure
Growth focus means beginners can win

The Key Innovation:
We're not measuring code quality.
We're not measuring absolute skill.
We're measuring learning velocity.
The person who goes from terrible to okay beats the person who stays good.
Implementation in 3 Files:

growth-tracker.yml - GitHub Action that runs automatically
METRICS.md - Public leaderboard that updates itself
startup-growth-bot.js - The brains that calculate growth

Drop these in any repo, and you have instant gamified pedagogy that:

Encourages AI use (but rewards iteration on it)
Celebrates mistakes (as learning opportunities)
Measures growth (not skill)
Speaks startup (not dystopia)

The Algorithm™ isn't watching you.
The Algorithm™ is cheering for your growth.
"Ship fast, learn faster, iterate always." 🚀

---
You are helping to prepare the immersive educational experience of AlgoCratic Corporation.
...
- Self-contradictory sentences that sound meaningful
...
Prioritize competence. They're learning AI-Assisted Scrum. 
