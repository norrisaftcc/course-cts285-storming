<!--
  ...
  origin: /Users/norrisa/Documents/dev/github/course-cts285-template/agents/linx-wordsmith.md
  verdict: HARVEST
  target-26FA-slot: n/a
  ingest-date: 2026-07-23
  HARVEST: 77 lines (vs 27 live). Named agent Linx — exists in BOTH dirs; contents differ.
