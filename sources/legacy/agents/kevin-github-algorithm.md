<!--
  ...
  origin: /Users/norrisa/Documents/dev/github/course-cts285-template/agents/kevin-github-algorithm.md
  verdict: HARVEST
  target-26FA-slot: n/a
  ingest-date: 2026-07-23
  HARVEST: 157 lines (vs 59 live). Named agent Kevin — exists in BOTH agents/ and .claude/agents/, and the two differ.
